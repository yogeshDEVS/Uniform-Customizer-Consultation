...
const PantDetails = () => {
    const [pantColor, setPantColor] = useState('#006548'); // Default color
    ...
    // const [logoPosition, setLogoPosition] = useState('knee');
    ...
    const handleAddScreenshotUri = (uri) => {
        ...
        ref.current.capture().then((capturedUri) => {
          ...
          const item = {
            ...
            // color: pantColor, // The selected color for the shirt
            size: selectedSize, 
        ...
        <ScrollView contentContainerStyle={styles.container} alwaysBounceVertical={true}>
            ...
            <View style={styles.pantContainer}>
                    <Image
                        ...
                        style={[styles.pantImage, { tintColor: pantColor }]}
                    />
